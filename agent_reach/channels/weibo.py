...
class WeiboChannel(Channel):
    ...
    def check(self, config=None):
        ...
        try:
            ...
            return "warn", "MCP is configured but tool loading failed; check mcp-server-weibo version"
        except Exception:
            return "warn", "MCP connection error; check if mcp-server-weibo is available"
